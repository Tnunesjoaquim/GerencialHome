          ...
          <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-base md:text-lg">
                Aqui está o resumo da <span className="text-primary font-bold">Casa Principal</span> para hoje.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="flex justify-between items-start z-10">
                ...
                <span className="text-[10px] font-bold text-red-500 bg-red-100 dark:bg-red-900/30 px-2 py-1 rounded">1 conta atrasada</span>
              </div>
              <div className="z-10">
                <p className="text-slate-500 text-xs font-bold uppercase tracking-wider">Saldo Mensal</p>
                <h3 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white mt-1">R$ 2.450,00</h3>
                ...
                <p className="text-[10px] text-slate-400 mt-2 font-medium">42% DESPESAS PAGAS</p>
              </div>
            ...
            >
              <div className="flex justify-between items-start z-10">
                ...
                <span className="text-[10px] font-bold text-orange-600 bg-orange-100 dark:bg-orange-900/30 px-2 py-1 rounded">5 baixos</span>
              </div>
              <div className="z-10">
                <p className="text-slate-500 text-xs font-bold uppercase tracking-wider">Estoque Geral</p>
                <h3 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white mt-1">42 Itens</h3>
                <p className="text-[10px] text-slate-500 mt-2 font-medium">VENCIMENTOS: <span className="font-bold text-red-500">2</span></p>
                <Link href="/estoque" className="text-primary text-xs font-bold flex items-center gap-1 mt-4 hover:underline">
            ...
            >
              ...
              <div className="z-10">
                ...
                <h3 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white mt-1 leading-tight line-clamp-1">Planejamento</h3>
                <p className="text-xs text-slate-500 mt-1">Hoje às <span className="font-bold text-primary">09:00 AM</span></p>
