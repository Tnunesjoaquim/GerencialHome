...
export default function SelectResidence() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark">
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-primary/10 px-6 py-4 lg:px-20 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md sticky top-0 z-40">
        ...
        <div className="flex gap-3">
          <button className="flex size-10 cursor-pointer items-center justify-center rounded-xl bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300 hover:bg-primary/20 transition-colors">
      ...
      <main className="flex flex-1 justify-center py-10 px-6 lg:px-20">
        <div className="flex flex-col max-w-[1200px] flex-1 gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-slate-500 dark:text-zinc-400 text-lg font-normal">Escolha qual imóvel você deseja gerenciar agora</p>
          </div>
          ...
          <div className="w-full">
            <div className="relative flex items-center w-full group">
              ...
              <input
                className="block w-full pl-12 pr-4 py-4 rounded-xl border-none bg-white dark:bg-zinc-800 shadow-sm focus:ring-2 focus:ring-primary text-slate-900 dark:text-white placeholder:text-slate-400 outline-none transition-all"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatePresence>
              {residences.map((residence) => (
                <motion.div
                  ...
                  className="group relative flex flex-col overflow-hidden rounded-2xl bg-white dark:bg-zinc-900 shadow-md hover:shadow-2xl transition-all border border-slate-100 dark:border-zinc-800 h-full"
                >
                  ...
                  <div className="p-6 flex flex-col gap-4 flex-1">
                    <div className="flex-1">
                      ...
                      <p className="text-slate-500 dark:text-zinc-400 flex items-center gap-1 text-sm mt-1">
            ...
            >
              ...
              <p className="text-slate-500 dark:text-zinc-400 text-sm text-center mt-2 px-4 italic">Cadastre um novo imóvel para começar a gerenciar.</p>
            </motion.div>
          </div>
        </div>
      </main>

      <footer className="px-6 lg:px-20 py-8 text-center bg-slate-50 dark:bg-zinc-900/50">
            ...
            >
              <div className="p-8">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button onClick={() => setIsModalOpen(false)} className="size-10 rounded-full hover:bg-slate-100 dark:-zinc- flex items-center justify-center transition-colors">
                ...
                <div className="flex flex-col gap-5">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-800 focus:ring-2 focus:ring-primary outline-none transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      />
                      {showSuggestions && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-xl shadow-xl z-10 overflow-hidden animate-in fade-in slide-in-from-top-2">
                  ...
                  {formData.image && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-2 text-center">
                      ...
                      <div className="w-full h-32 rounded-xl bg-cover bg-center border border-slate-200 dark:border-zinc-800" style={{ backgroundImage: `url(${formData.image})` }} />
                    </motion.div>
                  )}
                </div>
                ...
                <div className="mt-10 flex gap-4">
                  <button
                    onClick={() => setIsModalOpen(false)}
                    className="flex-1 py-4 rounded-xl font-bold bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-zinc-300 hover:brightness-95 transition-all"
                  >
                    Cancelar
                  </button>
                  <button
