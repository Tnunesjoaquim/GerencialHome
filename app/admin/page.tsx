      ...
      <main className="flex-1 flex flex-col p-4 md:p-10 mx-auto w-full max-w-[1400px] gap-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base">Administre permissões e fluxos de trabalho da equipe centralizada.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-primary/10 dark:border-primary/20 shadow-sm flex flex-col justify-between h-32 relative overflow-hidden group">
            <div>
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl overflow-x-auto scrollbar-thin">
                ...
                <tr key={i} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors group">
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-4">
                      <div className="size-10 rounded-xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-black text-xs text-slate-400 group-hover:text-primary transition-colors border border-slate-200 dark:border-slate-700">{user.initials}</div>
                  ...
                  <td className="px-8 py-5 text-slate-500 dark:text-slate-400 font-bold italic text-xs">{user.houses}</td>
        ...
        <motion.div
          whileHover={{ y: -5 }}
          className="mt-8 p-10 rounded-[40px] bg-slate-900 dark:bg-white text-white dark:text-slate-900 border-2 border-primary/20 flex flex-col items-center text-center shadow-2xl relative overflow-hidden"
        >
          ...
          <p className="text-slate-400 dark:text-slate-500 max-w-xl mb-8 font-medium italic">Integre eventos de staff com seus sistemas externos automaticamente. Arquitetura robusta para notificações em tempo real.</p>
